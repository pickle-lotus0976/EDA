...
#
# Script generated by Vivado on Thu Sep 18 01:30:20 +0530 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : adder_ip.sh
...
#
# Usage        : adder_ip.sh
#                adder_ip.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                adder_ip.sh [-reset_run]
#                adder_ip.sh [-reset_log]
#                adder_ip.sh [-help]
#
...
export RDI_DATADIR="C:/FPGA_Dev/2025.1/Vivado/data"

# set xvhdl options
xvhdl_opts="--incr --relax "

# script info
echo -e "adder_ip.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./adder_ip.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_14 -L c_reg_fd_v12_0_10 -L xbip_dsp48_wrapper_v3_0_7 -L xbip_pipe_v3_0_10 -L c_addsub_v12_0_20 -L secureip -L xpm --snapshot adder_ip xil_defaultlib.adder_ip -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim adder_ip -key {Behavioral:sim_1:Functional:adder_ip} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/FPGA_Dev/2025.1/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb adder_ip.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./adder_ip.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: adder_ip.sh [-help]\n\
Usage: adder_ip.sh [-step]\n\
Usage: adder_ip.sh [-lib_map_path]\n\
Usage: adder_ip.sh [-reset_run]\n\
Usage: adder_ip.sh [-reset_log]\n\
Usage: adder_ip.sh [-keep_index]\n\
Usage: adder_ip.sh [-noclean_files]\n\n\
